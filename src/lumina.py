...
class LuminaNextDiT2DModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        block_hidden_states: list[torch.Tensor] = None,
        return_dict=True,
    ) -> torch.Tensor:
        """
        ...
        for i, layer in enumerate(self.layers):
            ...
            if block_hidden_states is not None and i < len(block_hidden_states):
                hidden_states = hidden_states + block_hidden_states[i]
